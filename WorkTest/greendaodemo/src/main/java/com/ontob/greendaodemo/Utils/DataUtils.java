package com.ontob.greendaodemo.Utils;
...
public class DataUtils {
    ...
    public static List<GoodsModule> getGoodsModels (String json){
        List<GoodsModule> result = new ArrayList<>();
        try {
            JSONArray jsonArray = new JSONArray(json);
            for (int i = 0 ; i < jsonArray.length() ; i ++) {
                JSONObject object = jsonArray.getJSONObject(i);
                GoodsModule goodsModel = new GoodsModule();
