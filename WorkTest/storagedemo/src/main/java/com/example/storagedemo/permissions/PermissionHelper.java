package com.example.storagedemo.permissions;
...
public class PermissionHelper {
    ...
    public void requestPermissions(String[] permissions) {
        String[] deniedPermissions = PermissionUtil.getDeniedPermissions(mActivity, permissions);//获取permissions 权限数组中没有被授权的权限
